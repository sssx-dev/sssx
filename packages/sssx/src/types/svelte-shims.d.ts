...
// from https://github.com/sveltejs/language-tools/blob/master/packages/svelte2tsx/svelte-shims.d.ts
...
type _SvelteComponent<Props = any, Events = any, Slots = any> = typeof import('svelte') extends {
  SvelteComponentTyped: any;
}
  ? import('svelte').SvelteComponentTyped<Props, Events, Slots>
...
type SvelteComponentConstructor<T, U extends Svelte2TsxComponentConstructorParameters<any>> = new (
  options: U
) => T;
...
type SvelteSlotsAnyFallback<Slots> = {
...
declare type __sveltets_1_CustomEvents<T> = {
  [K in KeysMatching<T, CustomEvent>]: T[K] extends CustomEvent ? T[K]['detail'] : T[K];
};
...
declare function __sveltets_1_ensureFunction(
  expression: (e: Event & { detail?: any }) => unknown
): {};
// Includes undefined and null for all types as all usages also allow these
declare function __sveltets_1_ensureType<T>(
  type: AConstructorTypeOf<T>,
  el: T | undefined | null
): {};
declare function __sveltets_1_ensureType<T1, T2>(
  type1: AConstructorTypeOf<T1>,
  type2: AConstructorTypeOf<T2>,
  el: T1 | T2 | undefined | null
): {};

declare function __sveltets_1_createEnsureSlot<Slots = Record<string, Record<string, any>>>(): <
  K1 extends keyof Slots,
  K2 extends keyof Slots[K1]
>(
  k1: K1,
  k2: K2,
  val: Slots[K1][K2]
...
declare function __sveltets_1_slotsType<Slots, Key extends keyof Slots>(
  slots: Slots
): Record<Key, boolean>;
...
declare function __sveltets_1_partial<Props = {}, Events = {}, Slots = {}>(render: {
  props: Props;
  events: Events;
  slots: Slots;
}): {
  props: Expand<SveltePropsAnyFallback<Props>>;
  events: Events;
  slots: Expand<SvelteSlotsAnyFallback<Slots>>;
};
declare function __sveltets_1_partial<
  Props = {},
  Events = {},
  Slots = {},
...
>(
  ...
  props: Expand<SvelteWithOptionalProps<SveltePropsAnyFallback<Props>, OptionalProps>>;
  events: Events;
  slots: Expand<SvelteSlotsAnyFallback<Slots>>;
};

declare function __sveltets_1_partial_with_any<Props = {}, Events = {}, Slots = {}>(render: {
  props: Props;
  events: Events;
  slots: Slots;
}): {
  props: Expand<SveltePropsAnyFallback<Props> & SvelteAllProps>;
  events: Events;
  slots: Expand<SvelteSlotsAnyFallback<Slots>>;
};
declare function __sveltets_1_partial_with_any<
  Props = {},
  Events = {},
  Slots = {},
  OptionalProps extends keyof Props = any
>(
  ...
  props: Expand<
    SvelteWithOptionalProps<SveltePropsAnyFallback<Props>, OptionalProps> & SvelteAllProps
  >;
  events: Events;
  slots: Expand<SvelteSlotsAnyFallback<Slots>>;
};

declare function __sveltets_1_with_any<Props = {}, Events = {}, Slots = {}>(render: {
  props: Props;
  events: Events;
  slots: Slots;
}): { props: Expand<Props & SvelteAllProps>; events: Events; slots: Slots };

declare function __sveltets_1_with_any_event<Props = {}, Events = {}, Slots = {}>(render: {
  props: Props;
  events: Events;
  slots: Slots;
...
declare function __sveltets_1_store_get<Store extends SvelteStore<any> | undefined | null>(
  store: Store
): Store extends SvelteStore<infer T> ? T : Store;
...
declare function __sveltets_1_mapElementTag(tag: any): any; // needs to be any because used in context of <svelte:element>

declare function __sveltets_1_bubbleEventDef<Events, K extends keyof Events>(
  events: Events,
  eventKey: K
): Events[K];
declare function __sveltets_1_bubbleEventDef(events: any, eventKey: string): any;

declare const __sveltets_1_customEvent: CustomEvent<any>;
declare function __sveltets_1_toEventTypings<Typings>(): {
...
declare function __sveltets_1_unionType<T1, T2, T3, T4>(
  t1: T1,
  t2: T2,
  t3: T3,
  t4: T4
...
declare function __sveltets_1_createSvelte2TsxComponent<Props, Events, Slots>(render: {
  props: Props;
  events: Events;
  slots: Slots;
}): SvelteComponentConstructor<
  _SvelteComponent<Props, Events, Slots>,
...
// v2
declare function __sveltets_2_createCreateSlot<Slots = Record<string, Record<string, any>>>(): <
  SlotName extends keyof Slots
>(
  slotName: SlotName,
  attrs: Slots[SlotName]
) => Record<string, any>;
declare function __sveltets_2_createComponentAny(
  props: Record<string, any>
): _SvelteComponent<any, any, any>;

declare function __sveltets_2_any(...dummy: any[]): any;
declare function __sveltets_2_empty(...dummy: any[]): {};
declare function __sveltets_2_union<T1, T2, T3, T4, T5>(
  t1: T1,
  t2?: T2,
  t3?: T3,
  t4?: T4,
...
declare function __sveltets_2_ensureAnimation(
  animationCall: __sveltets_2_SvelteAnimationReturnType
): {};
...
type __sveltets_2_SvelteTransitionReturnType =
  | __sveltets_2_SvelteTransitionConfig
  | (() => __sveltets_2_SvelteTransitionConfig);
declare function __sveltets_2_ensureTransition(
  transitionCall: __sveltets_2_SvelteTransitionReturnType
): {};

// Includes undefined and null for all types as all usages also allow these
declare function __sveltets_2_ensureType<T>(
  type: AConstructorTypeOf<T>,
  el: T | undefined | null
): {};
declare function __sveltets_2_ensureType<T1, T2>(
  type1: AConstructorTypeOf<T1>,
  type2: AConstructorTypeOf<T2>,
  el: T1 | T2 | undefined | null
): {};
...
declare function __sveltets_2_ensureComponent<T extends ConstructorOfATypedSvelteComponent>(
  type: T
): T;

declare function __sveltets_2_ensureArray<T extends ArrayLike<unknown>>(
  array: T
): T extends ArrayLike<infer U> ? U[] : any[];
